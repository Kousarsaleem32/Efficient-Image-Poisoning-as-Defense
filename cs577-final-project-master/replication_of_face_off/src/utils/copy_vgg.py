...
def copy():
    """Copies files from a facenet dataset directory"""
...
def sample():
    """Samples files from the dataset directory"""
...
def move():
    """Moves newly generated files to a new directory"""
...
def remove():
    """Removes specific types of files in a directory"""
...
def move_duplicates():
    """Moves duplicate files from directory into a dump directory"""
